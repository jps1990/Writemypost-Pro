...
import { Lock, History as HistoryIcon, Filter, Trash2 } from 'lucide-react';
...
export function History() {
  ...
  return (
    <>
      <SEO 
        title="Historique - WriteMyPost.pro"
        description="Consultez l'historique de vos posts générés et analysez leurs performances."
      />
